...
<head>
    ...
    <script>
        ...
        async function GenerarPDFCita(id_Cita) {
            
            const url = `ReporteTuCita.php?id_Cita=${id_Cita}`;
        ...
        async function GenerarPDFCitaCancelada(id_Cita) {
            
            const url = `ReporteTuCitaCancelada.php?id_Cita=${id_Cita}`;
