...
<table class="table table-dark" style="width: 25%; "> 
    <thead>
        <tr> 
            <th><img src="../Principal/Logo.png" height="90" width="90" alt="..."></th> 
    ...
    <tbody> 
        ...
        <td colspan="3"> 
                ...
                <select name="Genero" id="opciones" class="custom-select">
...
<table class="InformacionDeLaCita" style="width: 70%">
                ...
                <?php  
                      ...
                      while($row=mysqli_fetch_array($query2)):?>
                        ...
                        <td><?php echo $row['CitasCanceladas'] ?> </td>
                </tr>
                <?php endwhile;?>
                <tr class="SubtituloPaciente">
                    <td colspan="2"></td>
                    <td colspan="2"> 
                    <form class="BotonesLargos" method="get" action="../ReportesPDF/ReporteTopPacientesQueCancelan.php" target="_blank">
