...
function Header()
{
    ...
    $this->Cell(60);
    // Título
    $this->Cell(70,10,'Age Recovery',0,1,'C');
    $this->Cell(60);
    $this->SetFont('Arial','',15);
    $this->Cell(70,10,'Comprobante De Cita',0,1,'C');
    $this->Cell(60);
    $this->Ln(15);
...
while ($row = $resultado->fetch_assoc()) {
    ...
    $pdf->Cell(30,7,$row['NombrePaciente'],1,0,'C',0);
	$pdf->Cell(30,7,$row['NombreMedico'],1,0,'C',0);
	$pdf->Cell(25,7,$row['Fecha'],1,0,'C',0);
    $pdf->Cell(25,7,$row['Hora'],1,0,'C',0);
    $pdf->Cell(25,7,$row['Estatus'],1,1,'C',0);
